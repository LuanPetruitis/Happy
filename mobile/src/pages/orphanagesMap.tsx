    ...
    return (
            <View style={styles.container}>
              ...
              <Text style={styles.footerText}>{orphanages.length} orfanatos encontrados</Text>
                <RectButton style={styles.createOrphanageButton} onPress={handleNavigationToOrphanage}>
...
// Todos os elementos no react-native tem DISPLAY: FLEX
